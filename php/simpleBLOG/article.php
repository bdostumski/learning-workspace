...
<body>
  ...
  <div class="container">
    <h1 class="lead mt-5 mb-5">&nbsp;</h1>
    <h1 class="lead mt-5 mb-3"><i class="fas fa-book-reader"></i> Read Article</h1>
    <div class='text-white bg-dark rounded-lg article' id="article-main-mycolor">
      <div class='row'>
        <div class='col-12'>
      ...
      <div class='row'>
        <div class='col-12'>
          <div class='card-body'>
            <p class='card-text'>
              <img class="img-fluid rounded" src="<?php echo $data['article_image'];?>">
            </p>
          </div>
        </div>
      </div>
      ...
      <div class='row'>
        ...
        <div class='col-lg-4 col-sm-12'>
          <div class='alert text-center p-2 mr-3 ml-3'>
            <small>Published: <?php
  ...
  <div class="container-fluid container-footer">
    <div class="row text-muted bg-dark footer p-3 mt-5" id="footer-mycolor">
      <div class="col-lg-3 col-sm-12 pl-4 mb-4 pr-4">
