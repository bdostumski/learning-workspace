  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="navbar-mycolor">
      <a class="navbar-brand" href="../index.php"><i class="fas fa-user-astronaut mr-2"></i>My CMS |</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active ml-3" href="../../index.php"><i class="fas fa-home"></i> Home <span
    ...
    <div class="container">
      <h1 class="lead mt-5 mb-3"><i class="far fa-envelope"></i> Email already sended</h1>
      <div class="row">
        <div class="col-lg-6 col-sm-12 d-flex justify-content-center  bg-dark text-light rounded-lg"
          id="article-main-mycolor" style="margin-bottom:55px;">
          <form class="form-group" action="../../index.php" method="post" autocomplete="off">
            <h4 class=" mt-5 mb-5">Thanks for the email. <br> Will write as soon as possible.</h4>
            <input type="submit" name="emailSend" value="OK" class="btn btn-outline-primary ml-0 mb-5 pl-4 pr-4">
          </form>
        </div>
      </div>
    </div>
