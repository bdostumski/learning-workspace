#!/usr/bin/env bash
#
# This script creates an new user on the local system
# You must supply a username as an argument to the script
# Opionally, you can also provide a comment for the account as an argument
...
#
# If then don't supply at least one argument, then give them help.
if [[ "${#}" -lt 1 ]]; then
