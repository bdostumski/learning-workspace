...
public class CreateFeedbackInquiryInBoard implements Command {


    private static final int EXPECTED_NUMBER_OF_ARGUMENTS = 5;
    private static final String FAILED_TO_PARSE_CREATE_FEED_BACK_INQUIRY_IN_BOARD_COMMAND_PARAMETERS =
            "Failed to parse Create Feed Back Inquiry In Board command parameters.";
    private static final String SUCCESSFULLY_CREATED_FEED_BACK_INQUIRY_TO_BOARD = "Successfully created feed back inquiry to board";
    ...
    public CreateFeedbackInquiryInBoard(TeamsController teamsController, WorkItemsController itemsController, WimFactory factory) {
    ...
    public String execute(List<String> parameters) {
        ...
        WorkingItems workingItems = factory.createNewFeedback(title, description, rating);
        itemsController.addNewWorkItem(workingItems);
        teamsController.createWorkItemInBoard(teamName, boardName, workingItems);
        return SUCCESSFULLY_CREATED_FEED_BACK_INQUIRY_TO_BOARD;
    }
    ...
    private void parseParameters(List<String> parameters) {
        try {
            ...
            throw new IllegalArgumentException(FAILED_TO_PARSE_CREATE_FEED_BACK_INQUIRY_IN_BOARD_COMMAND_PARAMETERS);
        }
    }
}
