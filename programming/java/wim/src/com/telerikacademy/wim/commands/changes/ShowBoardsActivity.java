...
public class ShowBoardsActivity implements Command {
    ...
    private static final String FAILED_TO_PARSE_SHOW_BOARDS_ACTIVITY_COMMAND_PARAMETERS =
            "Failed to parse Show Boards Activity command parameters.";

    private TeamsController teamsController;
    private String teamName, boardName;

    public ShowBoardsActivity(TeamsController controller) {
    ...
    public String execute(List<String> parameters) {
        ...
        return teamsController.showBoardsActivity(teamName, boardName);
