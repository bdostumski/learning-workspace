...
public class ShowBoardsActivity_Test {
    ...
    @Test
    public void ShowAllBoardsActivity_Should_ThrowException_When_PassedLessArguments() {
        //Arrange
    ...
    @Test
    public void ShowAllBoardsActivity_Should_ThrowException_When_PassMoreArgument() {
        //Arrange
        List<String> list = new ArrayList<>();
        list.add(team.getName());
    ...
    @Test
    public void ShowAllBoardsActivity_Should_ShowAllBoardsActivity_When_PassExpectedArguments() {
        List<String> list = new ArrayList<>();
        list.add(team.getName());
        list.add(board.getName());
        ...
        System.out.println(teamsController.showBoardsActivity(team.getName(), board.getName()));
