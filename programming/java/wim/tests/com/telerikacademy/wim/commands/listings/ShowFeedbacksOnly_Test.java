...
public class ShowFeedbacksOnly_Test {
    ...
    public void before() {
        ...
        showFeedbacksOnly = new ShowFeedbacksOnly(itemsController);

    }

    @Test
    public void show_feedbacks_should_show_only_feedbacks() {
        ...
        Assertions.assertNotEquals("There are no registered feedbacks yet.", showFeedbacksOnly.execute(params));
    }
    ...
    public void show_stories_should_show_message_when_no_stories() {
        ...
        Assertions.assertEquals("There are no registered feedbacks yet.",showFeedbacksOnly.execute(params));
    }
