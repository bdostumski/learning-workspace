...
public class ChangeBugSeverity implements Command {
    ...
    public ChangeBugSeverity(WorkItemsController controller) {
    ...
    public String execute(List<String> parameters) {
        ...
        bug.changeSeverityType(SeverityType.valueOf(newSeverity.toUpperCase()));
        return "Bug Severity updated successfully";
    }
    ...
    private void parseParameters(List<String> parameters) {
        try {
            ...
            newSeverity = parameters.get(1);
        } catch (Exception e) {
            throw new IllegalArgumentException("Failed to parse Change Bug Severity command parameters.");
        }
    }
