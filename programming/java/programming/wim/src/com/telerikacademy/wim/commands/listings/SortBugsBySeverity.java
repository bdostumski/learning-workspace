...
public class SortBugsBySeverity implements Command {
    ...
    public SortBugsBySeverity(WorkItemsController controller) {
    ...
    public String execute(List<String> parameters) {
        ...
        Comparator<Bug> bySeverity = Comparator.comparing(Bug::getSeverityType).thenComparing(Bug::getBugStatusType);
