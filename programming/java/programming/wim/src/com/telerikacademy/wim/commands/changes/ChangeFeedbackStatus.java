...
public class ChangeFeedbackStatus implements Command {
    ...
    public ChangeFeedbackStatus(WorkItemsController controller) {
    ...
    public String execute(List<String> parameters) {
        ...
        feedBack.changeFeedBackStatusType(FeedBackStatusType.valueOf(newFeedbackStatus.toUpperCase()));
        return "Feedback status changed successfully";
    }
    ...
    private void parseParameters(List<String> parameters) {
        try {
            ...
            newFeedbackStatus = parameters.get(1);
        } catch (Exception e) {
