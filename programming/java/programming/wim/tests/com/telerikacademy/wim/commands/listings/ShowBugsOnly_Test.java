...
public class ShowBugsOnly_Test {
    ...
    public void before() {
        ...
        showBugsOnly = new ShowBugsOnly(itemsController);
    ...
    @Test
    public void show_bugs_should_show_only_bugs() {
        ...
        Assertions.assertNotEquals("There are no registered bugs yet.",
                showBugsOnly.execute(params));
    }

    @Test
    public void show_bugs_should_show_message_when_no_bugs() {
        List<String> params = new ArrayList<>();

        itemsController.addNewWorkItem(testStory);
        itemsController.addNewWorkItem(testFeedback);

        Assertions.assertEquals("There are no registered bugs yet.",
                showBugsOnly.execute(params));
    }
}
