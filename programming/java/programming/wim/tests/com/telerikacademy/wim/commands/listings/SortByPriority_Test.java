...
public class SortByPriority_Test {
    ...
    public void before() {
        ...
        testBugTwo = new BugImpl("ABug-For-Test", "Test-Bug-For-Testing", PriorityType.LOW, SeverityType.MAJOR);
        ...
        sortByPriority = new SortByPriority(itemsController);

    }

    @Test
    public void sort_should_sort_by_priority() {
        ...
        Assertions.assertNotEquals("There are no registered priority items yet.", sortByPriority.execute(params));
    }
    ...
    public void sort_should_show_message_when_no_items() {
        ...
        Assertions.assertEquals("There are no registered priority items yet.", sortByPriority.execute(params));
    }
